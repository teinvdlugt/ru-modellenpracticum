...
class FieldExtractorBase(_object):
    ...
    def fillCellFieldData3D(self, _cellTypeArrayAddr, _cellIdArrayAddr):
        return _PlayerPython.FieldExtractorBase_fillCellFieldData3D(self, _cellTypeArrayAddr, _cellIdArrayAddr)
...
class FieldExtractor(FieldExtractorBase):
    ...
    def fillCellFieldData3D(self, _cellTypeArrayAddr, _cellIdArrayAddr):
        return _PlayerPython.FieldExtractor_fillCellFieldData3D(self, _cellTypeArrayAddr, _cellIdArrayAddr)
...
class FieldExtractorCML(FieldExtractorBase):
    ...
    def fillCellFieldData3D(self, _cellTypeArrayAddr, _cellIdArrayAddr):
        return _PlayerPython.FieldExtractorCML_fillCellFieldData3D(self, _cellTypeArrayAddr, _cellIdArrayAddr)
